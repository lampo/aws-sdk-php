 ...
 * promise that is fulfilled with an {@see \RamseyAws\Credentials\CredentialsInterface}
 * or rejected with an {@see \RamseyAws\Exception\CredentialsException}.
 *
 * <code>
 ...
 * {@see RamseyAws\Credentials\CredentialProvider::chain}. This function accepts
...
class CredentialProvider
{
     ...
     * instance of RamseyAws\CacheInterface. Forwards calls when no credentials found
     ...
     * @see RamseyAws\Credentials\InstanceProfileProvider for $config details.
     */
     ...
     * @see RamseyAws\Credentials\EcsCredentialProvider for $config details.
     */
     ...
     * @param array $config Array of configuration data
     * @return callable
     * @see RamseyAws\Credentials\AssumeRoleCredentialProvider for $config details.
     */
