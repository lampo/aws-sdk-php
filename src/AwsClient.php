...
class AwsClient implements AwsClientInterface
{
     ...
     *   waiter, or paginator.
     * - credentials:
     *   (RamseyAws\Credentials\CredentialsInterface|array|bool|callable) Specifies
     *   the credentials used to sign requests. Provide an
     *   RamseyAws\Credentials\CredentialsInterface object, an associative array of
     *   "key", "secret", and an optional "token" key, `false` to use null
     *   credentials, or a callable credentials provider used to create
     *   credentials or return null. See RamseyAws\Credentials\CredentialProvider for
     ...
     *   is required. See RamseyAws\Endpoint\EndpointProvider for a list of built-in
     *   providers.
     * - handler: (callable) A handler that accepts a command object,
     *   request object and returns a promise that is fulfilled with an
     *   RamseyAws\ResultInterface object or rejected with an
     *   RamseyAws\Exception\AwsException. A handler does not accept a next handler
     ...
     *   RamseyAws\Signature\SignatureProvider for a list of built-in providers
    ...
    private function parseClass()
    {
        ...
        if ($klass === __CLASS__) {
            return ['', 'RamseyAws\Exception\AwsException'];
        }
        ...
        return [
            strtolower($service),
            "RamseyAws\\{$service}\\Exception\\{$service}Exception"
        ];
    }
