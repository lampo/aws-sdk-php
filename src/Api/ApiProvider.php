 ...
 * {@see RamseyAws\Exception\UnresolvedApiException}.
 *
 ...
 * {@see RamseyAws\or_chain}. This method accepts providers as arguments and
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \RamseyAws\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \RamseyAws\load_compiled_json($path);
