...
interface S3ClientInterface extends AwsClientInterface
{
     ...
     * use the {@see \RamseyAws\S3\S3Client::createPresignedRequest} method and get
     ...
     * @param array  $options RamseyAws\S3\BatchDelete options array.
     *
     * @see RamseyAws\S3\S3Client::listObjects
     ...
     *   function signature like `function (RamseyAws\Command $command) {...}`.
     ...
     *
     * @see RamseyAws\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see RamseyAws\S3\MultipartCopy for more info about multipart uploads.
     ...
     * @param array  $options   Options available in RamseyAws\S3\Transfer::__construct
     *
     * @see RamseyAws\S3\Transfer for more options and customization
     */
