...
use RamseyAws\S3\S3Client;
use RamseyAws\CloudTrail\Exception\CloudTrailException;

/**
 * The `RamseyAws\CloudTrail\LogFileIterator` provides an easy way to iterate over
